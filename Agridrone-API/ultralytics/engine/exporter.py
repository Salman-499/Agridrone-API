...
class Exporter:
    ...
    def export_onnx(self, prefix=colorstr("ONNX:")):
        ...
        if dynamic:
            ...
            dynamic = {"images": {0: "batch", 2: "height", 3: "width"}}  # shape(1,channels,640,640)
    ...
    def export_ncnn(self, prefix=colorstr("NCNN:")):
        ...
        cmd = [
            ...
            *pnnx_args,
            ...
            f'inputshape="{[self.args.batch, channels, *self.imgsz]}"',
        ]
    ...
    def _pipeline_coreml(self, model, weights_dir=None, prefix=colorstr("CoreML Pipeline:")):
        ...
        pipeline = ct.models.pipeline.Pipeline(
            input_features=[
                ("image", ct.models.datatypes.Array(channels, ny, nx)),
...
class NMSModel(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        Args:
            x (torch.Tensor): The preprocessed tensor with shape (N, channels, H, W).
